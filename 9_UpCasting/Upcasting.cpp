...
public:
	...
	// 자식 클래스에서 재정의 할 것으로 가대하는 멤버 함수
	// 함수 앞에 virtual 키워드를 붙힘
...
// Upcasting(업캐스팅)
// 자식 -> 부모로 별 다른 연산자 없이 자동으로 캐스팅(읽어지는) 되는 방법
